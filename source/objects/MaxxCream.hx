	...
	public function new(x,y){
		...
		override function use(){
			...
			{time:18.0,run:function(){
				say("Keep your voice down, what the hell is your deal?", null, 3);
			}},
			...
			{time:33.0,run:function(){
				say("Jesus Christ, ok but we have to do this my way.", null, 3);
			}},
			...
			{time:45.0,run:function(){
				say("The boss is gonna get suspicious if we just sit around talking.", null, 3);
			}},
